...
| **reset timer** | Minutes until session quota resets |
...
ccburn is called at most once every `CACHE_MAX_AGE` seconds (default: 120). Increase this if you want fewer API calls:
